...
const NewSidebar = ({ darkMode, toggleDarkMode }: NewSidebarProps) => {
  ...
  return (
    <div className="hidden lg:flex lg:flex-col lg:w-64 min-h-[calc(100vh-64px)] fixed bg-card/30 backdrop-blur-sm z-30">
      <div className="sticky top-20 flex flex-col h-[calc(100vh-100px)] w-full">
